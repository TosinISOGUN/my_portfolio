...
const featuredProjects: FeaturedProject[] = [
  {
    ...
    result: "A live, commercially available Jira app on the Atlassian Marketplace that turns a manual reporting chore into a one-click report, shipped and marketed by a team of one. One of three apps Isogun Labs has live on the Marketplace.",
    metrics: [
      { icon: Store, label: "Live on Marketplace", value: "3 apps" },
