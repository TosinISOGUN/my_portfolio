...
export function HeroScrollScene({ progress, travel, reducedMotion }: HeroScrollSceneProps) {
  ...
  return (
    <div className="relative aspect-[4/3] w-[116vw] max-w-none -translate-x-[1vw] sm:w-full sm:translate-x-0 xl:w-full">
      ...
      <div className="absolute inset-0 -translate-x-[3%] -translate-y-[36%] scale-[1.1] sm:-translate-x-[6%] sm:-translate-y-[3%] sm:scale-[1.02] md:-translate-y-[8%] xl:-translate-x-[6%] xl:translate-y-0 xl:scale-[1.02]">
